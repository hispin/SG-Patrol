...
public class DownloadOfflineTilesActivity2 extends ParentActivity implements OnMapClickListener {
...
// This contains the MapView in XML and needs to be called after the access token is configured.
        setContentView(R.layout.activity_dowmload_offline_tiles2);
...
// Start and show the progress bar
    ...
    private void endProgress(final String message) {
        ...
        // Show a toast
        Toast.makeText(DownloadOfflineTilesActivity2.this, message, Toast.LENGTH_LONG).show();
    }
//
